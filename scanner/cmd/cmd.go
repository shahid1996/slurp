...
import (
	...
	"github.com/hehnope/slurp/scanner/stats"
)
...
func setFlags() {
	...
	domainCmd.PersistentFlags().StringVar(&cfgGenerateFile, "generate_file", "./generated", "File to output permutations to")
	...
	keywordCmd.PersistentFlags().StringVar(&cfgGenerateFile, "generate_file", "./generated", "File to output permutations to")
